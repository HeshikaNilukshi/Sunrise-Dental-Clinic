...
public class EmailService {
    ...
    private String buildBookingConfirmationHtml(AppointmentResponse apt) {
        return "<div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px;'>"
                ...
                + "<p>Your dental appointment has been successfully scheduled. Details are below:</p>"
                ...
                + "<tr><td style='padding: 8px 0; color: #64748b;'>Date:</td><td style='padding: 8px 0; font-weight: bold;'>" + apt.getAppointmentDate() + "</td></tr>"
                + "<tr><td style='padding: 8px 0; color: #64748b;'>Time:</td><td style='padding: 8px 0; font-weight: bold;'>" + apt.getAppointmentTime() + "</td></tr>"
                + "<tr><td style='padding: 8px 0; color: #64748b;'>Estimated Cost:</td><td style='padding: 8px 0; font-weight: bold;'>LKR " + apt.getTotalCost() + "</td></tr>"
                + "</table>"
